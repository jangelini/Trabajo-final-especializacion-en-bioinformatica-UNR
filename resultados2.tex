...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=0.90\textwidth]{./Graficos/SelectedGyE3.png}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=0.75\textwidth]{./Graficos/MeanvsStability3.png}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=0.75\textwidth]{./Graficos/RelationshipAmongEnvironments2.png}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=0.70\textwidth]{./Graficos/www/exampledata2.png}
	\end{center}
