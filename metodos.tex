...
\end{itemize}
\begin{itemize}
\item EM-SVD: \citet{Perry2015} propusieron un método de imputación que combina el algoritmo EM con DVS. 
\end{itemize}
\begin{itemize}
...
Los elementos no obligatorios son:\textbf{PONGO LOS QUE APARECEN EN LA FIGURA}
